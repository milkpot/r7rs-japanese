...
\syntax
\hyper{clauses}は以下のいずれかの形をひとつ以上取ります。
\begin{scheme}
...
提供されている正確な特徴は処理系定義ですが、
移植性のために特徴の中核となる集合が付録~\ref{stdfeatures}に掲載されています。
...
従って2番目の\hyper{init}は最初の束縛の集合が見え初期化された環境で評価され、
以下同様です。
